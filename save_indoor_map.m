...
B5 = [[281;195], [281;277], [266;277], [266;195]] *0.0254;
B6 = [[281;277], [281;373], [0;373], [0;277]] *0.0254;
B7 = [[37;110], [37;277], [0;277], [0;110]] *0.0254;
...
B11 = (rec(20,22) + [60;226]) *0.0254;
B12 = (r(pi/2)*rec(52,5) + [165;251]) *0.0254;
B13 = (rec(75,4) + [213;149]) *0.0254;
B14 = (r(pi/2)*rec(73,3.25) + [124;36.5]) *0.0254;
% obstacles
...
%targets
B19 = (r(-pi/4)*rec(13,8) + [230;242]) *0.0254; % wood box
B20 = (r(-pi/6)*rec(14.5,10.25) + [144;265]) *0.0254; % card box
B21 = (r(pi/2)*rec(14.5,10.25) + [85;226]) *0.0254;
B22 = (r(pi/2)*rec(13,8) + [128;180]) *0.0254;
B23 = (rec(9,9) + [214;100]) *0.0254; % basketball
B24 = (rec(7,7) + [204;265]) *0.0254; % watermelol
...
%% Targets
T_verts =[[230;242], [144;265], [85;226], [128;180],...
          [214;100], [204;265],...
          [96;20], [40;64.5],...
...
scatter([144,85]*0.0254,[265,226]*0.0254,'ks') % card box
